<template>
  <div class="about">
    ...
    <section>
      ...
      <strong>
        原来，在js语言中，一旦计算返回的数值超出了Number.MAX_VALUE（1.7*10<sup>308</sup>），就会返回Infinity(一个数值，表示无穷大)。
    ...
    <section>
      <span>根据双精度浮点数的构成，精度位数是 53 bit。安全数的意思是在 -(2<sup>53</sup> - 1) 到 2<sup>53</sup> - 1 内的整数(包括边界)与唯一的双精度浮点数互相对应。举个例子比较好理解：</span>
      <pre>
        <code>
